...
public class Host
{
    ...
    public Host(string hostName, bool sendConfirmationReceipt = true)
    {
        Hostname = hostName;
    ...
    public void Listen()
    {
        if (!IsRegistered())
        {
            Log.LogMessage($"{Hostname} isn't resistered in registry");
        ...
        while ((data = Read()) != null)
        {
            ...
            try
            {
                ...
                receivedData = data.ToObject<ReceivedData>();
            ...
            {
                SendMessage(new Response(data, "Bad format of recived data").GetJObject()!);
                Log.LogMessage("Bad format of recived data:" + JsonConvert.SerializeObject(data));
            ...
            {
                SendMessage(new Response(data).GetJObject()!);
            }
